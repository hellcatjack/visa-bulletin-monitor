commit 9a25f69922c9284df21640a59b44dd16c6e81b0d
Author: hellcatjack <hellcatjack@users.noreply.github.com>
Date:   Sat Nov 15 19:22:01 2025 -0500

    Add agent guide and refine scheduler/docs

diff --git a/README.md b/README.md
index 132532a..8361b74 100644
--- a/README.md
+++ b/README.md
@@ -1,344 +1,346 @@
...
+# US Visa Bulletin Monitor (中国区域)
+
+自动监控美国国务院签证排期公告，专注于中国大陆地区的排期变化，并通过邮件或短信实时通知。
+
+## 功能特点
+
+- 自动抓取最新的 Visa Bulletin（即将发布的公告）
...
+  - **Email 邮件通知**（推荐，默认）- 支持 Gmail、QQ邮箱、163邮箱等
+  - **SMS 短信通知** - 通过 Twilio 发送
+- 智能调度：美东时间工作日（周一至周五）9 AM - 11 PM 每 15 分钟检查一次，支持抓取失败退避与自动顺延至下月
+- 月度管理：当月抓取成功后自动停止，下月重新激活
+- JSON 文件存储历史数据，易于查看和备份
+
+## 文档
...
+### SMS / 文本通知
+
+当检测到排期变化时，短信或纯文本通知会类似：
 
 ```
 美国签证排期更新 (中国大陆)
 ==============================
-上期: 2024-10 → 本期: 2024-11
+上期: 2024/10/01 → 本期: 2024/11/01
 
 【最终裁定日期 Final Action】
-  EB-2: 01JAN2020 → 15FEB2020 (📈 前进)
-  EB-3: 15JUN2018 → 01JUN2018 (📉 倒退)
+  EB-2: 2020/01/01 → 2020/02/15 (📈 前进)
+  EB-3: 2018/06/15 → 2018/06/01 (📉 倒退)
 
 【递件日期 Filing Dates】
-  EB-2: 01FEB2020 → C (✅ 有名额)
+  EB-2: 2020/02/01 → C (✅ 有名额)
